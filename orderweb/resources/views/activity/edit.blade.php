            ...
            <form action="{{ route('activity.update',$activity['id']) }}" method="POST">
                ...
                <div class="row form-group">
                    <div class="col-lg-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="description" id="description" value="{{ $activity['description'] }}" required>
                    </div>
                    <div class="col-lg-6 mb-4">
                        <label for="hours">Horas</label>
                        <input type="number" class="form-control" name="hours" id="hours" value="{{ $activity['hours'] }}" required>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-6 mb-4">
